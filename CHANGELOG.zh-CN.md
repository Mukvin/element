...
### 4.0.60
*2022-06-01*
- 新增：新规范 icon （large close、linked、unlinked）

### 4.0.59
*2022-05-24*
- 修改：progress 小尺寸环形进度条组件样式更改
- 修改：message close 关闭按钮
- 修改：tabs 更改 close 按钮交互（hover 展示）
- 隐藏：组件没有用到的例子
- 新增：upload 组件当文件名过长时支持 hover 展示 tooltip
...
### 4.0.46
*2021-11-18*
- 新增：message 组件上新增两个全局参数，支持统一配置关闭时间和关闭按钮的出现与否

### 4.0.42
*2021-10-21*
- 恢复被修改的 icon
- 修改：tree 组件控制节点是否显示展开箭头
- 修改：notification 组件间距统一更改
...
*2021-09-16*
- 新增若干 icon
- 新增：懒加载 tree 时，如果没有数据，左侧展开箭头不隐藏
