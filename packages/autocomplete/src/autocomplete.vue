<template>
  ...
  >
    ...
    <el-autocomplete-suggestions
      ...
      <li :class="['load-more', { 'is-disabled': loadingMore }]" v-if="showLoadMore" @click.prevent="handleLoadingMore"><i class="el-icon-loading" v-if="loadingMore"></i>{{loadMoreText}}</li>
    </el-autocomplete-suggestions>
  </div>
</template>
<script>
